        ...
        <div class="card mb-4">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <h4 class="mb-0">
                        <i class="fa fa-plus text-primary"></i> Create Departments
                    </h4>
                ...
                <form method="post">
                    <div class="">
                        <div class="form-floating mb-3">
                            <input type="text" name="department" class="form-control w-50" id="departments" placeholder="departments" value="<?php echo old('departments'); ?>">
                        ...
                        <?php }; ?>
                        <button class="btn btn-primary d-block text-uppercase" name="addDept"><i class="fa fa-plus me-2"></i>Add Departments</button>
                    </div>
